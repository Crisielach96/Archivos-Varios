...
void mostrarDatos(eAuto coche[],  int);
void cargarDatos(eAuto coche[],int);
void bajaDatos(eAuto coche[],  int);
void modificarDatos(eAuto coche[],  int);
void ordenarPorNombre(eAuto coche[],  int);
